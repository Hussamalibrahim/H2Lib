...
//                )
    ...
    public JsonUsernamePasswordAuthenticationFilter jsonFilter(AuthenticationManager authManager) {
        ...
        JsonUsernamePasswordAuthenticationFilter filter =
                new JsonUsernamePasswordAuthenticationFilter(authManager, jwtService, rememberMeServices(), loginAttemptService);
        ...
        filter.setAuthenticationSuccessHandler((request, response, authentication) -> {
            ...
            String email = ((UserPrincipalImp) authentication.getPrincipal()).getEmail();
